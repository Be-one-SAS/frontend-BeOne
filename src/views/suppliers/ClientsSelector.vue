      ...
      <div class="p-1">
        ...
        <div class="flex items-center gap-4 mt-1 mb-2">
          <label class="flex items-center gap-2 text-[13px] text-[#0F1A2E] cursor-pointer">
            <input type="radio" value="INDIRECTO" v-model="nuevoCliente.type" class="w-4 h-4 text-[#27C8D8] border-gray-300 focus:ring-[#27C8D8]" />
            INDIRECTO
          </label>
          <label class="flex items-center gap-2 text-[13px] text-[#0F1A2E] cursor-pointer">
            <input type="radio" value="DIRECTO" v-model="nuevoCliente.type" class="w-4 h-4 text-[#27C8D8] border-gray-300 focus:ring-[#27C8D8]" />
            DIRECTO
          </label>
        </div>
