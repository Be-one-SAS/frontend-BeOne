...
const PERMISSIONS: Record<AppModule, Record<AppRole, AccessLevel>> = {
  cotizaciones: {
    ...
    LIDER: 'FULL', SUPERVISOR: 'READ', COORDINADOR: 'OWN', LOGISTICO: 'NONE',
  },
  clientes: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'READ',
    LIDER: 'FULL', SUPERVISOR: 'NONE', COORDINADOR: 'NONE', LOGISTICO: 'NONE',
  },
  productos: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'READ',
    LIDER: 'READ', SUPERVISOR: 'READ', COORDINADOR: 'NONE', LOGISTICO: 'NONE',
  },
  reservas: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'READ',
    LIDER: 'FULL', SUPERVISOR: 'FULL', COORDINADOR: 'NONE', LOGISTICO: 'NONE',
  },
  inventario: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'READ',
    LIDER: 'NONE', SUPERVISOR: 'FULL', COORDINADOR: 'NONE', LOGISTICO: 'NONE',
  },
  control: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'NONE',
    LIDER: 'NONE', SUPERVISOR: 'FULL', COORDINADOR: 'FULL', LOGISTICO: 'FULL',
  },
  materiales: {
    ADMIN: 'FULL', ADMINISTRADOR: 'FULL', DIRECCION: 'NONE',
    LIDER: 'NONE', SUPERVISOR: 'FULL', COORDINADOR: 'FULL', LOGISTICO: 'FULL',
  ...
  reportes: {
    ...
    LIDER: 'NONE', SUPERVISOR: 'NONE', COORDINADOR: 'NONE', LOGISTICO: 'NONE',
  },
  usuarios: {
